...
class P3_LCE(nn.Module):
    ...
    def __init__(self, channels, dw_kernel=3, reduction=16, act=True):
        super().__init__()

        assert dw_kernel in [3, 5], "dw_kernel should be 3 or 5"
        ...
        # SE-style lightweight channel attention
...
class P3_SCE(nn.Module):
    """
    Small-object Context Enhancement for P3
    Safe for RT-DETR backbone insertion
    """
