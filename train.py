...
if __name__ == '__main__':
    model = RTDETR('/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/ultralytics/cfg/models/rt-detr/rtdetr-P3_locenhance.yaml')
    ...
    model.train(data='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/dataset/data.yaml',
                ...
                project='runs/train',
                name='exp-visdrone2019-P3_locenhance',
                )