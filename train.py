...
if __name__ == '__main__':
    model = RTDETR('/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/ultralytics/cfg/models/rt-detr/rtdetr-C2f-Additive-SOEP.yaml')
    ...
    model.train(data='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/dataset/data.yaml',
                ...
                # device='0,1', # 指定显卡和多卡训练参考<使用教程.md>下方常见错误和解决方案
                 resume='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/runs/train/exp-visdrone2019-rtdetr-C2f-Additive-SOEP/weights/last.pt', # last.pt path
                patience=0, # 设置0代表不早提供，设置30代表精度持续30epoch没有比之前最高的高就早停
                project='runs/train',
                name='exp-visdrone2019-rtdetr-C2f-Additive-SOEP',
                )