...
if __name__ == '__main__':
    model = RTDETR('/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/ultralytics/cfg/models/rt-detr/rtdetr-C2f-AddutuveBlock-CGLU.yaml')
    ...
    model.train(data='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/dataset/data.yaml',
                ...
                # resume='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/runs/train/exp-visdrone2019-P3_locenhance/weights/last.pt', # last.pt path
                patience=0, # 设置0代表不早提供，设置30代表精度持续30epoch没有比之前最高的高就早停
                project='runs/train',
                name='exp-visdrone2019--C2f-AddutuveBlock-CGLU',
                )