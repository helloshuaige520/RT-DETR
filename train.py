...
if __name__ == '__main__':
    ...
    model.train(data='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/dataset/cityperson.yaml',
                ...
                # resume='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/runs/train/rtdetr-C2f-Additive-CGLU + P2 Head - SVFL+NWD3/weights/last.pt', # last.pt path
                patience=50, # 设置0代表不早提供，设置30代表精度持续30epoch没有比之前最高的高就早停
                project='runs/train',
                name = 'pcmsa-lgaf-cityperson'
                # name='rtdetr-C2f-Additive-CGLU+P2 Head-ema-svfl-iou0.6-cls3.0',
                )
