...
if __name__ == '__main__':
    model_path = '/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/runs/train/rtdetr-C2f-Additive-CGLU+P2-loss_hparameter_SVFLNWD_v1/weights/best.pt'
    ...
    result = model.val(data='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/dataset/data.yaml',
                      ...
                      project='runs/val',
                      name='exp-rtdetr-C2f-Additive-CGLU+P2-loss_hparameter_SVFLNWD_v1',
                      )
