...
if __name__ == '__main__':
    model_path = '/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/runs/train/exp-visdrone2019-rtdetr-P2/weights/best.pt'
    ...
    result = model.val(data='/home/rtdetr/project/RTDETR-20251122/RTDETR-20251122/RTDETR-main/dataset/data.yaml',
                    ...
                    #   save_json=True, # if you need to cal coco metrice
                      project='runs/val',
                      name='exp-visdrone2019-rtdetr-P2',
                      )
